...
class Product {
    ...
    public:
        void addProduct() {
            ...
            cin >> p_id;
            cout<< "Choice of Product Type : Electronics, Household, Furniture";
            cin >> p_category;
            cout << "Input product quantity: ";
            cin >> p_qty;
        }
        void showProduct() {
            cout << p_name << " " << p_id << " " << p_category << " " << p_qty << endl;
        }
};
